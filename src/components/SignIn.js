  ...
  return (
    <section className="bg-[#ffffff] dark:bg-gray-900">
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        ...
        <div className="w-full bg-[#FFFFFF] shadow-[0_10px_110px_1px_rgba(0,0,0,0.08)] rounded-[10px] border border-[#F4F5F6]  md:mt-0 sm:max-w-md xl:p-0 ">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            <form className="space-y-4 md:space-y-6" action="#">
              ...
              <div className="relative">
                ...
                />
                <svg
                  className="absolute top-[41px] right-[15px] cursor-pointer"
                  width="20"
                  height="17"
                  viewBox="0 0 20 17"
                  fill="none"
